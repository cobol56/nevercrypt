...
public abstract class LocationBase implements Location, Cloneable
{
    ...
    public static class ExternalSettings implements Location.ExternalSettings
    {
        ...
        protected void storeProtectedField(JSONObject jo, String key, String data)
        {
            ...
            {
                if (data != null)
                    jo.put(key, _protectionKeyProvider == null ? data : SimpleCrypto.encrypt(_protectionKeyProvider.getProtectionKey(), data));
            }
            catch (Exception ignored)
            {
            }
        ...
        {
            return _protectionKeyProvider == null ? SimpleCrypto.toHexString(data) : SimpleCrypto.encrypt(_protectionKeyProvider.getProtectionKey(), data);
        }
        ...
        {
            return _protectionKeyProvider == null ? data.getBytes() : SimpleCrypto.decrypt(_protectionKeyProvider.getProtectionKey(), data);
        }
    }

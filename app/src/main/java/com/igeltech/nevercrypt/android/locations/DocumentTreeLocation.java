...
public class DocumentTreeLocation extends LocationBase
{
    ...
    {
        return DocumentsContract.buildTreeDocumentUri(locationUri.getAuthority(), DocumentsContract.getTreeDocumentId(locationUri));
    }
    ...
    {
        DocumentTreeLocation loc = new DocumentTreeLocation(context, getDocumentUri(locationUri));

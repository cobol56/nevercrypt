...
public class AskExtStorageWritePermissionDialog extends DialogFragment
{
    ...
    public AppCompatDialog onCreateDialog(Bundle savedInstanceState)
    {
        ...
        builder.setMessage(R.string.ext_storage_write_permission_request).setPositiveButton(R.string.grant, (dialog, id) -> {
            dialog.dismiss();
    ...
    private ExternalStorageOpenerFragment getRecFragment()
    {
        return (ExternalStorageOpenerFragment) getFragmentManager().
                findFragmentByTag(getArguments().getString(LocationOpenerBaseFragment.PARAM_RECEIVER_FRAGMENT_TAG));
    }
}

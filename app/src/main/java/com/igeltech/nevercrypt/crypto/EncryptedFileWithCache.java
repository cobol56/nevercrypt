...
public class EncryptedFileWithCache extends EncryptedFile
{
    ...
    public EncryptedFileWithCache(RandomAccessIO base, VolumeLayout layout) throws FileNotFoundException
    {
    ...
    public EncryptedFileWithCache(RandomAccessIO base, VolumeLayout layout, int maxNumberCachedBuffers, int bufferSizeInBlocks) throws FileNotFoundException
    {

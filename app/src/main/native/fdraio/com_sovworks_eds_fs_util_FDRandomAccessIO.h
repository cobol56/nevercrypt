...
#include <jni.h>
/* Header for class com_igeltech_nevercrypt_fs_util_FDRandomAccessIO */

#ifndef _Included_com_igeltech_nevercrypt_fs_util_FDRandomAccessIO
#define _Included_com_igeltech_nevercrypt_fs_util_FDRandomAccessIO
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_igeltech_nevercrypt_fs_util_FDRandomAccessIO
 * Method:    flush
 * Signature: (I)V
 */

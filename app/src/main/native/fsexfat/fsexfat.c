...
#include <exfat.h>
#include "com_igeltech_nevercrypt_fs_exfat_ExFat.h"
#include "libexfat/exfat.h"
#include "../util/jniutil.h"
#include "raio.h"
#include "mkfs/mkexfat.h"

#define EDSEXFAT_VERSION 10001

#define LOGI(...) __android_log_print(ANDROID_LOG_INFO, "Nevercrypt (native code fsexfat)", __VA_ARGS__);

#define EXFAT_CLASSNAME "com/igeltech/nevercrypt/fs/exfat/ExFat"
#define FILE_STAT_CLASSNAME "com/igeltech/nevercrypt/fs/util/FileStat"
#define COLLECTION_CLASSNAME "java/util/Collection"

#define EXFAT_PTR_SIG "_exfatPtr","J"
#define EXFAT_IMAGE_SIG "_exfatImageFile","Lcom/igeltech/nevercrypt/fs/RandomAccessIO;"
...
JNIEXPORT jlong JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_openFS(JNIEnv *env, jobject instance, jboolean readOnly)
{
    int rc;
    struct exfat* ef;
...
JNIEXPORT jint JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_getAttr(JNIEnv *env, jobject instance, jobject fileStat, jstring pathString)
{
    const char *path;
...
Java_com_igeltech_nevercrypt_fs_exfat_ExFat_readDir(
...
JNIEXPORT jint JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_makeDir
...
JNIEXPORT jint JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_makeFile
        (JNIEnv *env, jobject instance, jstring pathString)
{
    struct exfat *ef = get_exfat(env, instance);
    if(ef == NULL)
...
JNIEXPORT jlong JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_getFreeSpace
...
Java_com_igeltech_nevercrypt_fs_exfat_ExFat_getFreeSpaceStartOffset(JNIEnv *env, jobject instance)
{
    struct exfat *ef = get_exfat(env, instance);
    if(ef == NULL)
        return -1;
...
JNIEXPORT jint JNICALL
Java_com_igeltech_nevercrypt_fs_exfat_ExFat_randFreeSpace(JNIEnv *env, jobject instance)
{
    exfat_debug("[%s]", __func__);
    struct exfat *ef = get_exfat(env, instance);
    if(ef == NULL)
...
JNIEXPORT jlong JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_getTotalSpace
        (JNIEnv *env, jobject instance)
{
    struct exfat *ef = get_exfat(env, instance);
    if(ef == NULL)
...
JNIEXPORT jint JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_rename
...
JNIEXPORT jint JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_delete
        (JNIEnv *env, jobject instance, jstring pathString)
{
    struct exfat_node* node;
    struct exfat *ef = get_exfat(env, instance);
...
JNIEXPORT jint JNICALL
Java_com_igeltech_nevercrypt_fs_exfat_ExFat_rmdir(JNIEnv *env, jobject instance, jstring pathString)
{
    struct exfat_node* node;
    struct exfat *ef = get_exfat(env, instance);
    if(ef == NULL)
...
JNIEXPORT jint JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_truncate
...
JNIEXPORT jint JNICALL
Java_com_igeltech_nevercrypt_fs_exfat_ExFat_updateTime(JNIEnv *env, jobject instance, jstring pathString, jlong time)
{
...
JNIEXPORT jlong JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_openFile
        (JNIEnv *env, jobject instance, jstring pathString)
{
    struct exfat_node* node;
    struct exfat *ef = get_exfat(env, instance);
...
JNIEXPORT jint JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_closeFile
...
JNIEXPORT jlong JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_getSize
        (JNIEnv *env, jobject instance, jlong handle)
{
    struct exfat_node* node = (struct exfat_node *) handle;
    exfat_debug("[%s] ", __func__);
...
JNIEXPORT jint JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_read
...
JNIEXPORT jint JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_write
        (JNIEnv *env, jobject instance, jlong handle, jbyteArray buf, jint bufOffset, jint count, jlong position)
{
    exfat_debug("[%s] (%zu bytes)", __func__, count);
    struct exfat_node* node = (struct exfat_node *) handle;
...
JNIEXPORT jint JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_flush
        (JNIEnv *env, jobject instance, jlong handle)
{
    struct exfat_node* node = (struct exfat_node *) handle;
    struct exfat *ef = get_exfat(env, instance);
...
JNIEXPORT jint JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_closeFS
        (JNIEnv *env, jobject instance)
{
    struct exfat *ef = get_exfat(env, instance);
    if(ef == NULL)
...
JNIEXPORT jint JNICALL Java_com_igeltech_nevercrypt_fs_exfat_ExFat_makeFS(JNIEnv *env, jclass type, jobject raio, jstring labelString,
...
JNIEXPORT jint JNICALL
Java_com_igeltech_nevercrypt_fs_exfat_ExFat_getVersion(JNIEnv *env, jclass type)
{
